public class Huffman {
    ...
    // bitstring-encoded tre til output
    ...
    public static void expand() {
        ...
        // les Huffman tree fra input stream
        Node root = readTree(); 
    ...
    private static Node readTree() {
        ...
        if (isLeaf) {
            ...
            return new Node('\0', -1, readTree(), readTre());
        }
    }
